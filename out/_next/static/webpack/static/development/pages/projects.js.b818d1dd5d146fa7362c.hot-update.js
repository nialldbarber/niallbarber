...
function (_Component) {
  ...
  _createClass(Projects, [{
    ...
    value: function render() {
      ...
      var projectOne = this.props.projects[1].data;
      var projectTwo = this.props.projects[0].data;
      var projectThree = this.props.projects[2].data;
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_styles_PageHeader__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ...
        title: projectOne.project_title[0].text,
        image: projectOne.project_image.url,
        link: projectOne.project_link[0].text
        ...
        title: projectTwo.project_title[0].text,
        image: projectTwo.project_image.url,
        link: projectTwo.project_link[0].text
      })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_anchor_link_smooth_scroll__WEBPACK_IMPORTED_MODULE_3___default.a, {
        className: "project-grid-item",
        href: '#' + this.state.projects[0].project3.link
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Project__WEBPACK_IMPORTED_MODULE_6__["default"], {
        title: projectThree.project_title[0].text,
        image: projectThree.project_image.url,
        link: projectThree.project_link[0].text
...
//# sourceMappingURL=projects.js.b818d1dd5d146fa7362c.hot-update.js.map