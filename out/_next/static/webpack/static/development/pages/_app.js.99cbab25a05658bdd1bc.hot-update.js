  ...
  _createClass(Nav, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(NavBar, {
        ...
        __self: this
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_hamburger_menu__WEBPACK_IMPORTED_MODULE_3___default.a, (_React$createElement = {
        className: "hamburger-menu"
      }, _defineProperty(_React$createElement, "className", this.state.isActive ? 'active' : ''), _defineProperty(_React$createElement, "isOpen", this.state.open[3]), _defineProperty(_React$createElement, "menuClicked", this.handleClick.bind(this, 3)), _defineProperty(_React$createElement, "width", 30), _defineProperty(_React$createElement, "height", 19), _defineProperty(_React$createElement, "strokeWidth", 1), _defineProperty(_React$createElement, "rotate", 0), _defineProperty(_React$createElement, "color", "white"), _defineProperty(_React$createElement, "borderRadius", 0), _defineProperty(_React$createElement, "animationDuration", 0.2), _defineProperty(_React$createElement, "__source", {
        fileName: _jsxFileName,
        lineNumber: 67
...
//# sourceMappingURL=_app.js.99cbab25a05658bdd1bc.hot-update.js.map