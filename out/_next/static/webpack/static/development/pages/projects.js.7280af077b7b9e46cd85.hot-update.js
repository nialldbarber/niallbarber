...
function (_Component) {
  ...
  _createClass(Projects, [{
    ...
    value: function render() {
      ...
      var projectList = this.props.projects; //console.log(this.props.projects);

      {
        Object.keys(projectList).map(function (item, i) {
          return console.log(_typeof(i), _typeof(item));
        });
      }
...
//# sourceMappingURL=projects.js.7280af077b7b9e46cd85.hot-update.js.map