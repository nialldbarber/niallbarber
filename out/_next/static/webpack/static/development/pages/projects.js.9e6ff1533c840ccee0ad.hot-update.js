...
function (_Component) {
  ...
  _createClass(Projects, [{
    ...
    value: function render() {
      ...
      var projectList = this.props.projects; // projectList.map(key => {
      // 	console.log(key.data.project_title[0].text);
      // });
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        __self: this
      }, this.props.projects, this.props.projects.map(function (key) {
...
//# sourceMappingURL=projects.js.9e6ff1533c840ccee0ad.hot-update.js.map